...
The current public beta is distributed as an Android APK. The Expo/React Native project contains iOS support, but the website does not currently offer an iOS release.
